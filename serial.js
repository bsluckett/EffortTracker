AmCharts.AmSerialChart = AmCharts.Class({inherits: AmCharts.AmRectangularChart, construct: function(a) {
    ...
    zoom: function(a, b) {
        ...
        for (n = 0; n < b; n++) {
            ...
            if ("100%" == l || "regular" == l)
                for (f = !1, k = 0; k < c; k++)
                    d = this.graphs[k], d.hidden || d.valueAxis != e || "column" != d.type || (!f && d.stackable && (a++, f = !0),
                            (!d.stackable && d.clustered || d.newStack) && a++, d.columnIndex = a - 1, d.clustered || (d.columnIndex = 0));
            if ("none" == l || "3d" == l)
                for (k = 0; k < c; k++)
                    d = this.graphs[k], !d.hidden && d.valueAxis == e && "column" == d.type && d.clustered && (d.columnIndex = a, a++);
            if ("3d" == l) {
                for (n = 0; n < c; n++)
                    d = this.graphs[n], d.depthCount = a;
                a = 1
            }
        }
        return a
        ...
        if (b) {
            ...
            for (var n = 0; n < c.length; n++) {
                for (var l = c[n], h = 0, g = 0, m, u, q, r, p, v = 0, A = 0, y, s, t, w, B, C = this.start; C <= this.end; C++) {
                    var x =
                            f[C];
                ...
                v = {open: y, close: s, high: w, low: t, average: B,
                    sum: v, count: A};
                a = AmCharts.formatValue(a, {open: m, close: u, high: r, low: q, average: p, sum: h, count: g}, d, k, l + "\\.", this.usePrefixes, this.prefixesOfSmallNumbers, this.prefixesOfBigNumbers);
                a = AmCharts.formatValue(a, v, d, this.pf, "percents\\." + l + "\\.")
            }
        }
        return a
        ...
        if (-1 != a.indexOf("[[category]]")) {
            ...
            if (this.categoryAxis.parseDates) {
                ...
                -1 != a.indexOf("[[category]]") &&
                        (f = AmCharts.formatDate(e, f), -1 != f.indexOf("fff") && (f = AmCharts.formatMilliseconds(f, e)), e = f)
            }
        ...
        this.rotate ? void 0 === a.width && (a.width = a.scrollbarHeight) : void 0 === a.height && (a.height =
                a.scrollbarHeight);
...
AmCharts.Cuboid = AmCharts.Class({construct: function(a, b, c, d, e, f, k, n, l, h, g, m, u, q, r) {
        this.set = a.set();
        this.container = a;
        this.h = Math.round(c);
        this.w = Math.round(b);
        ...
        var b = this.container, c = this.w, d = this.h, e = this.dx, f =
                this.dy, k = this.colors, n = this.alpha, l = this.bwidth, h = this.bcolor, g = this.balpha, m = this.gradientRotation, u = this.cornerRadius, q = this.dashLength, r = this.pattern, p = k, v = k;
        "object" == typeof k && (p = k[0], v = k[k.length - 1]);
        var A, y, s, t, w, B, C, x, z, D = n;
        r && (n = 0);
        if (0 < e || 0 < f)
            C = v, v = AmCharts.adjustLuminosity(p, -0.2), v = AmCharts.adjustLuminosity(p, -0.2), A = AmCharts.polygon(b, [0, e, c + e, c, 0], [0, f, f, 0, 0], v, n, 1, h, 0, m), 0 < g && (z = AmCharts.line(b, [0, e, c + e], [0, f, f], h, g, l, q)), y = AmCharts.polygon(b, [0, 0, c, c, 0], [0, d, d, 0, 0], v, n, 1, h, 0, m), y.translate(e,
        ...
        d = 0 > d ? [A, z, y, s, t, w, B, C, x, b] : [C, x, y, s, t, w, A, z, B, b];
...
AmCharts.CategoryAxis = AmCharts.Class({inherits: AmCharts.AxisBase, construct: function(a) {
        ...
        if (AmCharts.ifArray(a)) {
            ...
            var u, q, r, p, v, A;
            u = this.rotate;
            var y = this.firstDayOfWeek, s = this.boldPeriodBeginning, a = AmCharts.resetDateToMin(new Date(a[a.length -
            ...
            if (this.parseDates && !this.equalSpacing) {
                ...
                var k = Math.ceil(this.timeDifference / q) + 5, C = g = AmCharts.resetDateToMin(new Date(this.startTime - q), e,
                        u, y).getTime();
                r == e && 1 == u && this.centerLabelOnFullPeriod && (v = q * this.stepWidth);
                ...
                if (0 < this.gridCountR)
                    for (b = d; b <= k; b++) {
                        ...
                        A = !1;
                        this.nextPeriod[r] && (A = this.checkPeriodChange(this.nextPeriod[r], 1, m, g, r));
                        t = !1;
                        A && this.markPeriodChange ? (g = this.dateFormatsObject[this.nextPeriod[r]], this.twoLineMode && (g = this.dateFormatsObject[r] + "\n" + g, g = AmCharts.fixBrakes(g)), t = !0) : g = this.dateFormatsObject[r];
                        s || (t = !1);
                        ...
                        if (!isNaN(w))
                            for (h = 1; h < u; h += w)
                                this.gridAlpha = this.minorGridAlpha, t = m + B * h, t = AmCharts.resetDateToMin(new Date(t), e, w, y).getTime(), t = new this.axisItemRenderer(this, (t - this.startTime) * this.stepWidth), this.pushAxisItem(t);
                        this.gridAlpha = a
                    }
            } else if (!this.parseDates) {
                if (this.cellWidth = this.getStepWidth(b), b < k && (k = b), f += this.start, this.stepWidth = this.getStepWidth(b), 0 < k)
                    for (s = Math.floor(b / k), w = this.chooseMinorFrequency(s), h = f, h / 2 == Math.round(h / 2) && h--, 0 > h && (h = 0),
                            k = 0, this.end - h + 1 >= this.autoRotateCount && (this.labelRotation = this.autoRotateAngle), b = h; b <= this.end + 2; b++) {
                        p = !1;
                        0 <= b && b < this.data.length ? (r = this.data[b], g = r.category, p = r.forceShow) : g = "";
                        if (t && !isNaN(w))
                            if (b / w == Math.round(b / w) || p)
                                b / s == Math.round(b / s) || p || (this.gridAlpha = this.minorGridAlpha, g = void 0);
                            else
                                continue;
                        else if (b / s != Math.round(b / s) && !p)
                            continue;
                        ...
                        y = this.cellWidth;
                        u && (y = NaN);
                        this.labelFunction && r && (g = this.labelFunction(g, r, this));
                ...
                e = d.period;
                u = d.count;
                q = AmCharts.getPeriodDuration(e,
                        u);
                q < h && (e = m.period, u = m.count, q = h);
                r = e;
                "WW" == r && (r = "DD");
                ...
                q = h;
                if (this.data[h].time !=
                        AmCharts.resetDateToMin(new Date(this.data[h].time), e, u, y).getTime())
                    for (y = 0, x = g, b = h; b < v; b++)
                        m = this.data[b].time, this.checkPeriodChange(e, u, m, x) && (y++, 2 <= y && (q = b, b = v), x = m);
                t && 1 < u && (w = this.chooseMinorFrequency(u), AmCharts.getPeriodDuration(e, w));
                if (0 < this.gridCount)
                    for (b = h; b < v; b++)
                        if (m = this.data[b].time, this.checkPeriodChange(e, u, m, g) && b >= q) {
                            h = this.getCoordinate(b - this.start);
                            A = !1;
                            this.nextPeriod[r] && (A = this.checkPeriodChange(this.nextPeriod[r], 1, m, g, r));
                            t = !1;
                            A && this.markPeriodChange ? (g = this.dateFormatsObject[this.nextPeriod[r]],
                                    t = !0) : g = this.dateFormatsObject[r];
                            g = AmCharts.formatDate(new Date(m), g);
                            if (b == d && !n || b == k && !l)
                                g = " ";
                            B ? B = !1 : (s || (t = !1), h - this.previousPos > this.safeDistance * Math.cos(this.labelRotation * Math.PI / 180) && (this.labelFunction && (g = this.labelFunction(g, new Date(m), this, e, u, p)), p = new this.axisItemRenderer(this, h, g, void 0, void 0, void 0, void 0, t), y = p.graphics(), this.pushAxisItem(p), p = y.getBBox().width, AmCharts.isModern || (p -= h), this.previousPos = h + p));
                            p = g = m
                        } else
                            isNaN(w) || (this.checkPeriodChange(e, w, m, C) && (this.gridAlpha =
                                    this.minorGridAlpha, h = this.getCoordinate(b - this.start), t = new this.axisItemRenderer(this, h), this.pushAxisItem(t), C = m), this.gridAlpha = a)
            }
            for (b = 0; b < this.data.length; b++)
                if (n = this.data[b])
                    l = this.parseDates && !this.equalSpacing ? Math.round((n.time - this.startTime) * this.stepWidth + this.cellWidth / 2) : this.getCoordinate(b - f), n.x[this.id] = l;
            n = this.guides.length;
            for (b = 0; b < n; b++)
                l = this.guides[b], s = s = s = a = d = NaN, w = l.above, l.toCategory && (s = c.getCategoryIndexByValue(l.toCategory), isNaN(s) || (d = this.getCoordinate(s - f),
                        ...
                        a, l.label, !1, NaN, s, l), this.pushAxisItem(p, w)), d = new this.guideFillRenderer(this, a, d, l), a = d.graphics(), this.pushAxisItem(d, w), l.graphics = a, a.index = b, l.balloonText && this.addEventListeners(a, l)
        }
        this.axisCreated = !0;
        c = this.x;
        f = this.y;
        ...
        b[c] && (f = b[c].x[this.id]);
        d ? f > this.height + 1 && c-- : f > this.width +
                1 && c--;
        0 > f && c++;
