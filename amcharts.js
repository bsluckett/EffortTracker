if (!AmCharts)
    var AmCharts = {themes: {}, maps: {}, inheriting: {}, charts: [], onReadyArray: [], useUTC: !1, updateRate: 40, uid: 0};
...
AmCharts.wrappedText = function(a, b, c, d, e, f, g, h, k) {
    ...
    if (l) {
        ...
        if (p.width > h) {
            l.remove();
            for (var l = [], n = 0; - 1 < (index = b.indexOf(" ", n)); )
                l.push(index), n = index + 1;
            ...
            if (isNaN(r)) {
                ...
                for (n = 1; n < h; n++)
                    r = Math.round(b.length / h * n), b = b.substr(0, r) + m + b.substr(r);
...
AmCharts.recommended = function() {
    var a = "js";
    document.implementation.hasFeature("", "1.1") || swfobject && swfobject.hasFlashPlayerVersion("8") && (a = "flash");
    return a
};
...
AmCharts.AxisBase = AmCharts.Class({construct: function(a) {
        ...
        var a = this.position;
        "H" == this.orientation ? ("left" == a &&
                (a = "bottom"), "right" == a && (a = "top")) : ("bottom" == a && (a = "left"), "top" == a && (a = "right"));
        this.position = a
    }, draw: function() {
        var a = this.chart;
        this.allLabels = [];
        ...
        if (a) {
            ...
            0 < d.length() ?
                    e = d.getBBox() : (e.x = 0, e.y = 0, e.width = this.viW, e.height = this.viH);
            d.push(a);
            var d = e.x, f = e.y;
            ...
            switch (this.position) {
                ...
                case "left":
                    ...
                    break;
                case "right":
                    b = d + g + 10 + m - 3, p && (b += 7), c =
                            "left" == n ? k + 2 : "right" == n ? -2 : k / 2, l = -90
            }
...
AmCharts.ValueAxis = AmCharts.Class({inherits: AmCharts.AxisBase, construct: function(a) {
        ...
        if (this.logarithmic && (0 >= this.getMin(0, this.data.length -
            ...
            if (isNaN(this.min) || isNaN(this.max) || !this.foundGraphs || Infinity == this.min || -Infinity == this.max)
                ...
                var t, w = this.guides, y = w.length;
                if (0 < y) {
                    c = this.fillAlpha;
                    for (d = this.fillAlpha = 0; d < y; d++) {
                        var E = w[d], z = NaN, A = E.above;
                        isNaN(E.toValue) || (z = this.getCoordinate(E.toValue), t = new this.axisItemRenderer(this, z, "", !0, NaN, NaN, E), this.pushAxisItem(t, A));
                        var I = NaN;
                        isNaN(E.value) || (I = this.getCoordinate(E.value), t = new this.axisItemRenderer(this, I, E.label, !0, NaN, (z - I) / 2, E), this.pushAxisItem(t,
                                A));
                ...
                w = !1;
                for (d = n; d < s; d += p)
                    y = AmCharts.roundTo(this.step * d + this.min, r), -1 != String(y).indexOf("e") && (w = !0, String(y).split("e"));
                this.duration && (this.maxInterval = AmCharts.getMaxInterval(this.max, this.duration));
                var r = this.step, G, y = this.minorGridAlpha;
                this.minorGridEnabled && (G = this.getMinorGridStep(r, this.stepWidth * r));
                for (d = n; d < s; d += p)
                    if (n =
                            r * d + this.min, n = AmCharts.roundTo(n, this.maxDecCount + 1), !this.integersOnly || Math.round(n) == n)
                        if (isNaN(u) || Number(AmCharts.toFixed(n, u)) == n) {
                            ...
                            w ? (t = -1 == String(n).indexOf("e") ? n.toExponential(15) : String(n), c = t.split("e"), t = Number(c[0]), c = Number(c[1]), t = AmCharts.roundTo(t, 14), 10 == t && (t = 1, c += 1), t = t + "e" + c, 0 === n && (t = "0"), 1 == n && (t = "1")) : (h &&
                                    (t = String(n).split("."), t[1] ? (v.precision = t[1].length, 0 > d && (v.precision = Math.abs(d))) : v.precision = -1), t = this.usePrefixes ? AmCharts.addPrefix(n, a.prefixesOfBigNumbers, a.prefixesOfSmallNumbers, v, !0) : AmCharts.formatNumber(n, v, v.precision));
                            ...
                            if (!isNaN(G) &&
                                ...
                                for (c = 1; c < r / G; c++)
                                    E = this.getCoordinate(n + G * c), E = new this.axisItemRenderer(this, E, "", !1, 0, 0, !1, !1, 0, !0), this.pushAxisItem(E);
                                this.gridAlpha = t
                            }
                        }
                d = this.baseValue;
        ...
        if ("line" == a || "step" == a || "smoothedLine" == a)
            s = !0;
        if (s && ("regular" == b || "100%" == b))
            for (p = 0; p < h.length; p++)
                m = h[p], m.hidden || (l = m.type, m.chart == this.chart && m.valueAxis ==
...
AmCharts.RecItem = AmCharts.Class({construct: function(a, b, c, d, e, f, g, h, k, l) {
        ...
        this.set = q;
        var r = a.axisThickness, u = a.axisColor, v = a.axisAlpha, t = a.tickLength, w = a.gridAlpha, y = a.gridThickness, E = a.gridColor, z = a.dashLength, A = a.fillColor, I = a.fillAlpha, G = a.labelsEnabled, B = a.labelRotation, K = a.counter,
                M = a.inside, ca = a.dx, W = a.dy, Na = a.orientation, ga = a.position, ma = a.previousCoord, U = a.viH, X = a.viW, $ = a.offset, ra, P;
        ...
        P = "start";
        e && (P = "middle");
        var Y = B * Math.PI / 180, pa, H = 0, F = 0, V = 0, da = pa = 0, ha = 0;
        "V" == Na && (B = 0);
        var x;
        G && (x = a.autoWrap && 0 === B ? AmCharts.wrappedText(s, c, n, m, p, P, h, e, 0) : AmCharts.text(s, c, n, m, p, P, h), P = x.getBBox(), da = P.width, ha = P.height);
        if ("H" == Na) {
            if (0 <= b && b <= X + 1 && (0 < t && 0 < v && b + k <= X + 1 && (ra = AmCharts.line(s, [b + k, b + k], [0, t], u, v, y), q.push(ra)), 0 < w && (P = AmCharts.line(s, [b, b + ca, b + ca], [U, U + W, W], E, w, y, z), q.push(P))), F = 0, H = b, g && 90 == B && (H -= p), !1 === d ? (P = "start", F = "bottom" == ga ? M ? F + t : F - t : M ? F - t : F + t, H += 3, e && (H += e / 2, P = "middle"), 0 < B && (P = "middle")) : P =
                    ...
                    t + 3, H -= da / 2 * Math.cos(Y)) : F += t + 3 : 0 < B ? (F = -(da / 2) * Math.sin(Y) - t - 6, H += da / 2 * Math.cos(Y)) : F -= t + p + 3 + r + 3), "bottom" == ga ? pa = (M ? U - t - 1 : U + r - 1) + $ : (V = ca, pa = (M ? W : W - t - r + 1) - $), f && (H += f), W = H, 0 < B && (W += da / 2 * Math.cos(Y)), x && (ga = 0, M && (ga = da / 2 * Math.cos(Y)), W + ga > X + 2 || 0 > W))
                x.remove(), x = null
        } else {
            ...
            P = "end";
            if (!0 === M && "left" == ga || !1 === M && "right" == ga)
                P = "start";
            F = b - p / 2;
            1 ==
                    K && 0 < I && !g && !l && (d = AmCharts.fitToBounds(b, 0, U), ma = AmCharts.fitToBounds(ma, 0, U), Y = d - ma, fill = AmCharts.polygon(s, [0, a.width, a.width, 0], [0, 0, Y, Y], A, I), fill.translate(ca, d - Y + W), q.push(fill));
            F += p / 2;
        ...
        x && (x.attr({"text-anchor": P}), x.translate(H, F), 0 !== B && x.rotate(-B, a.chart.backgroundColor), a.allLabels.push(x), " " != c && (this.label = x));
...
AmCharts.AmChart = AmCharts.Class({construct: function(a) {
        ...
        this.amExport && (this.AmExport = AmCharts.extend(this.amExport, new AmCharts.AmExport(this), !0));
        ...
        a && (isNaN(a.precision) || (this.precision = a.precision), void 0 !== a.thousandsSeparator && (this.thousandsSeparator = a.thousandsSeparator), void 0 !== a.decimalSeparator &&
        ...
        if (this.mouseIsOver) {
            ...
            a || (a = window.event);
            a.wheelDelta ? b =
                    a.wheelDelta / 120 : a.detail && (b = -a.detail / 3);
    ...
    stopAnim: function(a) {
        ...
        var a =
                window.location.hostname.split("."), b;
...
AmCharts.AmGraph = AmCharts.Class({construct: function(a) {
        ...
        if (!W && ("line" == g || "smoothedLine" == g || "step" == g) && (1 == d.length && "step" != g && "none" == this.bullet && (this.bullet = "round", this.resetBullet = !0), Oa || void 0 != Da)) {
            ...
            n ? (eb = m, fb = Math.abs(yb -
                    ya), hb = m, ib = Math.abs($a - ya), Za = gb = 0, f.reversed ? (Xa = 0, Ya = ya) : (Xa = ya, Ya = 0)) : (fb = l, eb = Math.abs(yb - ya), ib = l, hb = Math.abs($a - ya), Ya = Xa = 0, f.reversed ? (Za = p, gb = ya) : Za = ya + 1)
        }
        var za = Math.round;
        this.pmx = za(Xa);
        this.pmy = za(gb);
        ...
        if ("line" == g || "step" == g || "smoothedLine" == g) {
            if (0 < M) {
                for (J = M - 1; - 1 < J; J--)
                    if (ha = d[J],
                            x = ha.axes[f.id].graphs[b], Wa = x.values.value, !isNaN(Wa)) {
                        M = J;
                        break
                    }
                if (this.lineColorField)
                    for (J = M; - 1 < J; J--)
                        if (ha = d[J], x = ha.axes[f.id].graphs[b], x.lineColor) {
                            this.bulletColorSwitched = this.lineColorSwitched = x.lineColor;
                            break
                        }
                if (this.fillColorsField)
                    for (J = M; - 1 < J; J--)
                        if (ha = d[J], x = ha.axes[f.id].graphs[b], x.fillColors) {
                            this.fillColorsSwitched = x.fillColors;
                            break
                        }
                if (this.dashLengthField)
                    for (J = M; - 1 < J; J--)
                        if (ha = d[J], x = ha.axes[f.id].graphs[b], !isNaN(x.dashLength)) {
            ...
            if (ca <
                    d.length - 1)
                for (J = ca + 1; J < d.length; J++)
                    if (ha = d[J], x = ha.axes[f.id].graphs[b], Wa = x.values.value, !isNaN(Wa)) {
                        ca = J;
                        break
                    }
        }
        ...
        var Q = [], R = [], Ea = !1;
        if ("line" == g || "step" == g || "smoothedLine" == g)
            if (this.stackable && "regular" == B || "100%" == B || this.fillToGraph)
                Ea = !0;
        ...
        for (J = M; J <= ca; J++) {
            ...
            x.index = J;
            var S, T, O, aa, ia = NaN, D = NaN, C = NaN, N = NaN, L = NaN, Ia = NaN, Aa = NaN, Ja = NaN, Ba = NaN, ba = NaN, fa = NaN, ja = NaN, ka = NaN, Z = NaN, jb = NaN,
                    kb = NaN, na = NaN, qa = void 0, Ca = Ob, Ra = Pa, sa = ra, oa, ta, Sa = this.pattern;
            ...
            if (ua) {
                ...
                if ("candlestick" == g || "ohlc" == g)
                    Z = ua.close, kb = ua.low, Aa = f.getCoordinate(kb), jb = ua.high, Ba = f.getCoordinate(jb);
                na = ua.open;
                C = f.getCoordinate(Z);
                isNaN(na) || (L =
                        f.getCoordinate(na));
                ...
                var ia = ha.x[Na.id], Ka = this.periodSpan - 1, la = Math.floor(V / 2) + Math.floor(Ka * V / 2), va = la, Ab = 0;
                ...
                switch (g) {
                    case "line":
                        if (isNaN(Z))
                            r || (this.drawLineGraph(u, v, Q, R), u = [], v = [], Q = [], R = []);
                        else {
                            x.isNegative = Z < ma ? !0 : !1;
                            if (Math.abs(D - ab) >= cb || Math.abs(C - bb) >= cb)
                                u.push(D), v.push(C), ab = D, bb = C;
                            ba = D;
                            fa = C;
                            ja = D;
                            ka = C;
                            !Ea || isNaN(L) || isNaN(N) || (Q.push(N),
                                    R.push(L));
                    ...
                    case "smoothedLine":
                        if (isNaN(Z))
                            r || (this.drawSmoothedGraph(u, v, Q, R), u = [], v = [], Q = [], R = []);
                        else {
                            x.isNegative = Z < ma ? !0 : !1;
                            if (Math.abs(D - ab) >= cb || Math.abs(C - bb) >=
                                    cb)
                                u.push(D), v.push(C), ab = D, bb = C;
                            ba = D;
                            fa = C;
                    ...
                    case "step":
                        if (!isNaN(Z)) {
                            if (x.isNegative = Z < ma ? !0 : !1, void 0 ==
                                    ...
                                    isNaN(L) || isNaN(N) || (Q.push(N - la), R.push(E), Q.push(N - la), R.push(L), Q.push(N + va), R.push(L))), t = D, w = C, y = N, E = L, ba = D, fa = C, ja = D, ka = C, zb || x.gap)
                                t = w = NaN, this.drawLineGraph(u, v, Q, R), u = [], v = [], Q = [], R = []
                        } else if (!r) {
                            if (1 >= this.periodSpan || 1 < this.periodSpan && D - t > la + va)
                                t = w = NaN;
                        ...
                        if (!isNaN(Z)) {
                            ...
                            if (!(Z < Bb && na < Bb ||
                                ...
                                if (n) {
                                    ...
                                    if (T < m && 0 < O && (qa = new AmCharts.Cuboid(e, aa, O, I - a.d3x, G - a.d3y, Ca, Ra, X, oa, $, H, q, n, P, Sa), "bottom" != K && "inside" != K && "middle" != K))
                                        if (K = f.reversed ? "left" : "right", 0 > Z)
                                            K = f.reversed ? "right" : "left";
                                        else if ("regular" == B || "100%" == B)
                                            ba += this.dx
                                } else {
                                    "3d" == B ? (S =
                                            D - 0.5 * (h + F) + F / 2 + I * U, T = L + G * U) : (S = D - (s / 2 - U) * (h + F) + F / 2, T = L);
                                    O = h;
                                    ba = S + h / 2;
                                    fa = C;
                                    ja = S + h / 2;
                                    ...
                                    if (S < l + U * I && 0 < O)
                                        if (qa = new AmCharts.Cuboid(e, O, aa, I - a.d3x, G - a.d3y, Ca, Ra, X, oa, this.lineAlpha, H, q, n, P, Sa), 0 > Z && "middle" != K && "inside" != K)
                                            K = "bottom";
                                        else if (K = pa, "regular" == B || "100%" == B)
                                            fa += this.dy
                                }
                            if (qa && (ta = qa.set, ta.translate(S, T), this.columnsSet.push(ta), (x.url || this.showHandOnHover) &&
                                    ta.setAttr("cursor", "pointer"), !W)) {
                                ...
                                if ("regular" == B || "100%" == B)
                                    "inside" != K && (K = "middle"), A = n ? 0 < ua.value ? (this.end + 1 - J) * z + c : (this.end + 1 - J) * z - c : 0 < ua.value ? z * J + c : z * J - c;
                                this.columnsArray.push({column: qa, depth: A});
                                x.x = n ? T + O / 2 : S + O / 2;
                                this.ownColumns.push(qa);
                                this.animateColumns(qa,
                                        J, D, N, C, L);
                    ...
                    case "candlestick":
                        if (!isNaN(na) && !isNaN(Z)) {
                            ...
                            } else if (S = D - h / 2, T = L + X / 2, O = h, S + O > l && (O = l - S), 0 > S && (O += S, S = 0), aa =
                                    C - L, S < l && 0 < O) {
                                var qa = new AmCharts.Cuboid(e, O, aa, I, G, Ca, Ra, X, oa, $, H, q, n, P, Sa), pb, qb;
                            ...
                            qa && (ta = qa.set, Y.push(ta), ta.translate(S, T - X / 2), (x.url || this.showHandOnHover) && ta.setAttr("cursor", "pointer"), db && (Y.push(db), Y.push(mb)), ba = D, fa = C, n ? (ka = C, ja = D, "open" == k && (ja = N), "high" == k && (ja = Ja), "low" == k && (ja = Ia)) : (ka = C, "open" == k && (ka = L), "high" == k && (ka = Ba), "low" ==
                                    k && (ka = Aa), ja = D), W || (x.x = n ? T + O / 2 : S + O / 2, this.animateColumns(qa, J, D, N, C, L), this.addListeners(ta, x)))
                        }
                        break;
                    case "ohlc":
                        if (!(isNaN(na) || isNaN(jb) || isNaN(kb) || isNaN(Z))) {
                            ...
                            var rb, sb, tb;
                            if (n) {
                                var ub = C - h / 2, ub = AmCharts.fitToBounds(ub, 0, m), Db = AmCharts.fitToBounds(C, 0, m), vb = C + h / 2, vb = AmCharts.fitToBounds(vb, 0, m);
                                sb = AmCharts.line(e, [N, N], [ub, Db], sa, $, X, P);
                                0 < C && C < m && (rb = AmCharts.line(e, [Ia, Ja], [C, C], sa, $, X, P));
                                tb = AmCharts.line(e, [D, D], [Db, vb], sa, $, X, P)
                            } else {
                                var wb = D -
                                        h / 2, wb = AmCharts.fitToBounds(wb, 0, l), Eb = AmCharts.fitToBounds(D, 0, l), xb = D + h / 2, xb = AmCharts.fitToBounds(xb, 0, l);
                ...
                if (!W && !isNaN(Z)) {
                    ...
                    if (this.end - this.start <= Fb || 0 === Fb) {
                        ...
                        if (Gb) {
                            var ea = this.createLabel(x, 0, 0, Gb), wa = 0,
                                    xa = 0, Hb = ea.getBBox(), La = Hb.width, Ga = Hb.height;
                            switch (K) {
                                case "left":
                                    wa = -(La / 2 + Fa / 2 + 3);
                                    break;
                                ...
                                case "right":
                                    ...
                                    break;
                                case "bottom":
                                    n && "column" == g ? (ba = ga, 0 > Z || 0 < Z && f.reversed ? (wa = -6, ea.attr({"text-anchor": "end"})) : (wa = 6, ea.attr({"text-anchor": "start"}))) : (xa = Fa / 2 + Ga / 2, ea.x = -(La / 2 + 2));
                                    break;
                                case "middle":
                                    "column" == g && (n ? (xa = -(Ga / 2) + this.fontSize / 2, wa = -(D - N) / 2 - I, 0 > aa && (wa += I), Math.abs(D - N) < La && !this.showAllValueLabels && (ea.remove(), ea = null)) : (xa = -(C - L) / 2, 0 >
                                            aa && (xa -= G), Math.abs(C - L) < Ga && !this.showAllValueLabels && (ea.remove(), ea = null)));
                                    break;
                                case "inside":
                                    n ? (xa = -(Ga / 2) + this.fontSize / 2, wa = 0 > aa ? La / 2 + 6 : -La / 2 - 6) : xa = 0 > aa ? Ga : -Ga
                            }
                            if (ea) {
                                if (isNaN(fa) || isNaN(ba))
                                    ea.remove(), ea = null;
                        ...
                        if ("regular" == B || "100%" == B) {
                            ...
                            if (Jb) {
                                ...
                                var Kb = Ma.getBBox(), Lb = Kb.width, Mb = Kb.height, Ta, Ua, Nb = f.totals[J];
                                Nb && Nb.remove();
                                var Va = 0;
                                "column" != g && (Va = Fa);
        ...
        if ("line" == g || "step" == g || "smoothedLine" == g)
            "smoothedLine" == g ? this.drawSmoothedGraph(u, v, Q, R) : this.drawLineGraph(u, v, Q, R), W || this.launchAnimation();
        ...
        if (1 < a.length) {
            ...
            var k = this.lineAlpha, l = this.lineThickness,
                    e = this.dashLength, m = this.fillAlphas, p = this.lineColorR, n = this.fillColorsR, s = this.negativeLineColor, q = this.negativeFillColors, r = this.negativeFillAlphas, u = this.baseCoord, v = this.lineColorSwitched;
            v && (p = v);
            ...
            0 < m && (k = a.join(";").split(";"), p = b.join(";").split(";"), l = "", 0 < c.length ? (c.push("M"), d.push("M"), c.reverse(),
        ...
        b && (this.rotate ? (b.translate(-1E3, e), c.translate(-1E3, e)) : (b.translate(d, -1E3), c.translate(d, -1E3)), b.animate({opacity: 1, translate: d +
                    "," + e}, f, a), c.animate({opacity: 1, translate: d + "," + e}, f, a))
    }, animate: function(a) {
        ...
        e = this.bullet;
        a.bullet && (e = a.bullet);
        var g = this.bulletBorderThickness, k = this.bulletBorderColorR,
                l = this.bulletBorderAlpha, s = this.bulletAlpha;
        k || (k = m);
        this.useLineColorForBulletBorder && (k = this.lineColorR);
        var q = a.alpha;
        isNaN(q) || (s = q);
        if ("none" != this.bullet || a.bullet)
            p = AmCharts.bullet(d, e, f, m, s, g, k, l, h, 0, n);
        if (this.customBullet || a.customBullet)
            n = this.customBullet, a.customBullet && (n = a.customBullet), n && (p && p.remove(), "function" == typeof n ? (p = new n, p.chart = this.chart, a.bulletConfig && (p.availableSpace = c, p.graph = this, a.bulletConfig.minCoord = this.minCoord - c, p.bulletConfig = a.bulletConfig), p.write(d),
                    p = p.set) : (this.chart.path && (n = this.chart.path + n), p = d.set(), d = d.image(n, 0, 0, f, f), p.push(d), this.centerCustomBullets && d.translate(-f / 2, -f / 2)));
...
AmCharts.ChartCursor = AmCharts.Class({construct: function(a) {
        ...
        if (a.mouseIsOver) {
            ...
            0 < b && b < this.width && 0 < c && c < this.height ? (this.drawing ? this.rolledOver || a.setMouseCursor("crosshair") : this.pan && (this.rolledOver || a.setMouseCursor("move")), this.rolledOver =
                    !0, this.setPosition()) : this.rolledOver && (this.handleMouseOut(), this.rolledOver = !1)
        } else
    ...
    zoom: function(a, b, c, d) {
        ...
        if (this.enabled) {
            ...
            this.fireMoved();
            if (s) {
                var q = s.x[g.id], r = c.rotate, u = g.inside, v = this.stepWidth, t = this.categoryBalloon, w = this.firstTime, y = this.lastTime, E = this.cursorPosition, z = g.position, A = this.zooming, I = this.panning, G = c.graphs, B = g.axisThickness;
                if (c.mouseIsOver || A || I || this.forceShow)
                    if (this.forceShow = !1, I) {
                        var h = this.panClickPos, c = this.panClickEndTime, A = this.panClickStartTime, K = this.panClickEnd, l = this.panClickStart, e = (r ? h - f : h - e) / v;
                        if (!g.parseDates || g.equalSpacing)
                            e = Math.round(e);
                        0 !== e && (h = {type: "zoomed", target: this}, h.chart = this.chart, g.parseDates && !g.equalSpacing ? (c + e > y && (e = y - c), A + e < w && (e = w - A), h.start = Math.round(A + e), h.end = Math.round(c + e), this.fire(h.type, h)) : K + e >= this.data.length || 0 > l + e || (h.start = l + e, h.end = K + e, this.fire(h.type, h)))
                    } else {
                        "start" ==
                                E ? q -= g.cellWidth / 2 : "mouse" == E && c.mouseIsOver && (q = r ? f - 2 : e - 2);
                        if (r) {
                            if (0 > q)
                                if (A)
                                    q = 0;
                        ...
                        if (0 < this.cursorAlpha) {
                            ...
                            0 < v && !this.zooming ? isNaN(this.previousX) ? M.translate(w, y) : (M.translate(this.previousX, this.previousY), M.animate({translate: w +
                                        "," + y}, v, "easeOutSine")) : M.translate(w, y);
                            this.previousX = w;
                            this.previousY = y;
                            M.show()
                        }
                        ...
                        if (this.oneBalloonOnly) {
                            ...
                            for (t = 0; t < G.length; t++)
                                g = G[t], g.showBalloon && !g.hidden && g.balloonText && (w = s.axes[g.valueAxis.id].graphs[g.id],
                                        y = w.y, isNaN(y) || (r ? Math.abs(e - y) < k && (k = Math.abs(e - y), K = g) : Math.abs(f - y) < k && (k = Math.abs(f - y), K = g)));
                            this.mostCloseGraph && (K = this.mostCloseGraph)
                        }
                        if (a != this.previousIndex || K != this.previousMostCloseGraph)
                            if (this.normalizeBulletSize(), this.destroyValueBalloons(), this.resizedBullets = [], G && this.valueBalloonsEnabled && v && c.balloon.enabled) {
                                this.valueBalloons = v = [];
                                for (t = 0; t < G.length; t++)
                                    if (g = G[t], (!this.oneBalloonOnly || g == K) && g.showBalloon && !g.hidden && g.balloonText && ("step" == g.type && "left" == g.stepDirection &&
                                            (s = this.data[a + 1]), s)) {
                                        ...
                                        if (this.showNextAvailable && isNaN(y) && a + 1 < this.data.length)
                                            for (k = a + 1; k < this.data.length; k++)
                                                if (q = this.data[k])
                                                    if (w = q.axes[g.valueAxis.id].graphs[g.id], y = w.y, !isNaN(y))
                                                        break;
                                        if (!isNaN(y)) {
                                            q = w.x;
                                            u = !0;
...
AmCharts.AmBalloon = AmCharts.Class({construct: function(a) {
        ...
        if (!isNaN(a)) {
            ...
            if (this.show) {
                ...
                var q = this.horizontalPadding, r = this.verticalPadding, u = this.pointerWidth, v = this.pointerOrientation, t = this.cornerRadius, w = c.fontFamily, y = this.fontSize;
                void 0 == y && (y = c.fontSize);
                var m = document.createElement("div"), E = m.style;
                E.position = "absolute";
                var z = this.minWidth, A = "";
                isNaN(z) || (A = "min-width:" + (z - 2 * q) +
                        "px; ");
                ...
                !isNaN(z) && A < z && (A = z);
                window.opera && (w += 2);
                var I = !1, y = this.offsetY;
                c.handDrawn && (y += c.handDrawScatter + 2);
                "H" != v ? (z = a - A / 2, b < h + w + 10 && "down" != v ? (I = !0, d && (b += y), y = b + u, this.deltaSignY = -1) :
                        (d && (b -= y), y = b - w - u, this.deltaSignY = 1)) : (2 * u > w && (u = w / 2), y = b - w / 2, a < g + (k - g) / 2 ? (z = a + u, this.deltaSignX = -1) : (z = a - A - u, this.deltaSignX = 1));
                y + w >= l && (y = l - w);
                y < h && (y = h);
                z < g && (z = g);
                z + A > k && (z = k - A);
                var h = y + r, l = z + q, r = this.shadowAlpha, G = this.shadowColor, q = this.borderThickness, B = this.bulletSize, K;
                0 < t || 0 === u ? (0 < r && (a = AmCharts.rect(e, A, w, p, 0, q + 1, G, r, this.cornerRadius), AmCharts.isModern ? a.translate(1, 1) : a.translate(4, 4), f.push(a)), p = AmCharts.rect(e, A, w, p, this.fillAlpha, q, n, this.borderAlpha, this.cornerRadius), this.showBullet &&
                ...
                0 < this.animationDuration && !d && !isNaN(this.prevX) && (f.translate(this.prevX, this.prevY), f.animate({translate: z - e + "," + y}, b, "easeOutSine"), m && (E.left = this.prevTX + "px", E.top = this.prevTY + "px", this.xAnim = c.animate({node: m}, "left", this.prevTX, l, b, "easeOutSine", "px"), this.yAnim = c.animate({node: m}, "top", this.prevTY, h, b, "easeOutSine", "px")));
                this.prevX = z - e;
                this.prevY =
                        y;
                this.prevTX = l;
...
AmCharts.AmCoordinateChart = AmCharts.Class({inherits: AmCharts.AmChart, construct: function(a) {
        ...
        if (e) {
            ...
            var l, m, p, n;
            f && (b = AmCharts.extractPeriod(h.minPeriod), l = b.period,
                    m = b.count, n = AmCharts.getPeriodDuration(l, m));
            var s = {};
            this.lookupTable = s;
            var q, r = this.dataDateFormat, u;
            for (q = 0; q < e.length; q++) {
                ...
                k && (v.forceShow = t[k]);
                s[t[d]] = v;
                f && (b = h.categoryFunction ? h.categoryFunction(b, t, h) : b instanceof Date ? "fff" == h.minPeriod ? AmCharts.useUTC ? new Date(b.getUTCFullYear(), b.getUTCMonth(), b.getUTCDate(), b.getUTCHours(), b.getUTCMinutes(), b.getUTCSeconds(), b.getUTCMilliseconds()) : new Date(b.getFullYear(),
                        b.getMonth(), b.getDate(), b.getHours(), b.getMinutes(), b.getSeconds(), b.getMilliseconds()) : new Date(b) : r ? AmCharts.stringToDate(b, r) : new Date(b), b = AmCharts.resetDateToMin(b, l, m, h.firstDayOfWeek), v.category = b, v.time = b.getTime());
        ...
        for (d = 0; d < b.length; d++) {
            ...
            f && (g = f.axes[g].graphs[a.id], g.serialDataItem = f, g.values = this.processValues(e,
                    a, a.periodValue), this.processFields(a, g, e))
        }
        ...
        a.fillColorsR = a.fillColors ? a.fillColors :
                a.lineColorR;
...
AmCharts.AmRectangularChart = AmCharts.Class({inherits: AmCharts.AmCoordinateChart, construct: function(a) {
        ...
        h = AmCharts.rect(a.container,
                p.width + 2 * m + 5, p.height + 2 * m - 2, h, 1, 1, h, c);
        h.setAttr("opacity", k);
        h.translate(-m, -m);
        b.push(h);
        h.toBack();
...
AmCharts.makeHD = function(a, b, c) {
    for (var d = [], e = [], f = 1; f < a.length; f++)
        for (var g = Number(a[f - 1]), h = Number(b[f - 1]), k = Number(a[f]), l = Number(b[f]), m = Math.sqrt(Math.pow(k - g, 2) + Math.pow(l - h, 2)), m = Math.round(m / 50) + 1, k = (k - g) / m, l = (l - h) / m, p = 0; p <= m; p++) {
...
AmCharts.handDrawnLine = function(a, b, c, d, e, f, g, h, k, l, m) {
    ...
    for (m = 1; m < b.length; m++)
        for (var n = [b[m - 1], b[m]], s = [c[m - 1], c[m]], s = AmCharts.makeHD(n, s, a.handDrawScatter), n = s[0], s = s[1], q = 1; q < n.length; q++)
            p.push(AmCharts.line(a, [n[q - 1], n[q]], [s[q - 1], s[q]], d, e, f + Math.random() * a.handDrawThickness - a.handDrawThickness / 2, g, h, k, l, !0));
    return p
};
...
AmCharts.wedge = function(a, b, c, d, e, f, g, h, k, l, m, p) {
    ...
    359.94 < r && (r = 359.94);
    e >= r && (e = r);
    var u = 1 / 180 * Math.PI, r = b + Math.sin(d * u) * h, v = c - Math.cos(d * u) * s, t = b + Math.sin(d * u) * f, w = c - Math.cos(d * u) * g, y = b + Math.sin((d + e) * u) * f, E = c - Math.cos((d + e) * u) * g, z = b + Math.sin((d + e) * u) * h, u = c - Math.cos((d + e) * u) * s, A = {fill: AmCharts.adjustLuminosity(l.fill, -0.2), "stroke-opacity": 0, "fill-opacity": l["fill-opacity"]}, I = 0;
    180 < Math.abs(e) && (I = 1);
    d = a.set();
    var G;
    ...
    0 < k && (q ? (B = " M" + r + "," + (v + k) + " L" + t + "," + (w + k), G || (B += " A" + (b - f) + "," + (k + c - g) + "," + (b + f) + "," + (k + c + g) + "," + t + "," + (w + k) + "," + y + "," + (E + k)), B += " L" + z + "," + (u + k), 0 < h && (G || (B += " B" + (b - h) + "," + (k + c - s) + "," + (b + h) + "," + (k + c + s) +
...
AmCharts.AmLegend = AmCharts.Class({construct: function(a) {
        ...
        if (!1 !== a.visibleInLegend) {
            ...
            if (this.useGraphSettings)
                if (m = a.type, this.switchType = void 0, "line" == m || "step" == m || "smoothedLine" == m || "ohlc" == m)
                    g = k.set(), a.hidden || (d = a.lineColorR, f = a.bulletBorderColorR), p = AmCharts.line(k, [0, 2 * l], [l / 2, l / 2], d, a.lineAlpha, a.lineThickness, a.dashLength), g.push(p), a.bullet && (a.hidden ||
                            (d = a.bulletColorR), p = AmCharts.bullet(k, a.bullet, a.bulletSize, d, a.bulletAlpha, a.bulletBorderThickness, f, a.bulletBorderAlpha)) && (p.translate(l + 1, l / 2), g.push(p)), n = 0, m = l, p = l / 3;
                else {
                    var s;
                    a.getGradRotation && (s = a.getGradRotation());
                    m = a.fillColorsR;
                    !0 === a.hidden && (m = d);
                    if (g = this.createMarker("rectangle", m, a.fillAlphas, a.lineThickness, d, a.lineAlpha, s, g))
                        n = l, g.translate(n, l / 2);
                    m = l
                }
            else
                h ? (b.path && (h = b.path + h), g = k.image(h, 0, 0, l, l)) : (g = this.createMarker(c, d, e, void 0, void 0, void 0, void 0, g)) && g.translate(l /
                        2, l / 2);
